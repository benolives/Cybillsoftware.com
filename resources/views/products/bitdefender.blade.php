...
<main class="">
    <!-- Hero Section -->
    <section id="bitdefender-hero-section" class="relative min-h-[510px] w-full">
        <div class="absolute top-0 left-0 w-full h-full overflow-hidden">
            <picture class="block h-full w-full">
                <source srcset="{{ asset('assets/img/bitdefender_banner.avif') }}" media="(min-width: 1440px)">
                <source srcset="{{ asset('assets/img/bitdefender_banner.avif') }}" media="(max-width: 640px)">
                <img src="{{ asset('assets/img/bitdefender_banner.avif') }}" class="w-full h-full object-cover object-center" alt="Kaspersky hero section background">
            </picture>
        </div>
        ...
        <div class="content_section relative w-full flex items-center justify-center flex-col text-center min-h-[510px] px-[32px] text-white">
            <div class="content-wrapper w-full max-w-[840px] flex flex-col items-start">
                <h1 class="mb-2 text-[1.8rem] font-extrabold text-white capitalize text-center w-full">
                    Bitdefender Software Products
                </h1>
                <p class="font-normal text-sm mb-6 text-white">
                    With Bitdefender Software, you can easily start reselling and earn commission with just a few clicks. Our platform is designed to help you maximize your earnings with a user-friendly interface, marketing tools, and comprehensive support.
                </p>            
                <!-- Search Form -->
                <div class="bg-white shadow-md border border-[#ebecf0] h-[56px] pl-6 rounded-full w-full flex items-center relative">
                    <form class="flex-1 flex items-center justify-center min-w-[32px]" action="#" method="GET">
                        ...
                        <input 
                            type="search" 
                            name="search" 
                            placeholder="Search for Bitdefender products..." 
    ...
    <div class="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 md:px-8">
        @foreach ($bitdefenderProducts as $product)
            <div class="bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                ...
                <div class="flex flex-col items-center py-6">
                    <img 
                        src="{{ asset('assets/img/bitdefender_logo.jpg') }}" 
                        alt="{{ $product['name'] }}" 
                ...
                <!-- Learn More Button -->
                <a href="{{ route('product.details', ['id' => $product->product_api_id]) }}" 
