    ...
    <div class="bg-white flex items-center justify-center min-h-screen">
        <div class="max-w-md w-full mx-auto p-6 rounded-lg shadow-lg bg-white">
            ...
            <p class="mt-4 text-center text-gray-600">
                A verification email has been sent to <span class="font-semibold text-gray-800">{{ $email }}</span>.
            ...
            @endif
            <form action="{{ route('verification.send') }}" method="post" class="mt-4 flex justify-center">
                @csrf
